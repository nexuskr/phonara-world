...
export const DEFAULT_MISSIONS: Mission[] = [
  ...
  { id: "g4",  title: "VIP 럭키 휠",            desc: "최대 50,000원 당첨",        reward: 8_000,    category: "게임",   difficulty: "VIP",    tier: "VIP",    duration: "5초",  game: "lucky" },
  { id: "m9",  title: "GOD 모드 데이터 큐레이션", desc: "고가치 데이터셋 큐레이션",     reward: 120_000,  category: "데이터", difficulty: "VIP",    tier: "GOD",    duration: "60분" },
  { id: "m10", title: "GOD AI 트레이너 세션",    desc: "AI 모델 RLHF 평가",         reward: 250_000,  category: "AI",     difficulty: "VIP",    tier: "GOD",    duration: "90분" },
  { id: "g5",  title: "GOD 럭키 휠",            desc: "최대 500,000원 당첨",       reward: 50_000,   category: "게임",   difficulty: "VIP",    tier: "GOD",    duration: "5초",  game: "lucky" },
  { id: "m11", title: "EMPIRE 콘텐츠 캠페인",    desc: "단독 UGC 영상 제작",         reward: 850_000,  category: "UGC",    difficulty: "VIP",    tier: "EMPIRE", duration: "1일",  ugc: true },
  { id: "m12", title: "EMPIRE 자산 신호 검토",   desc: "팬텀 카운슬 전용 보고서",      reward: 1_500_000, category: "데이터", difficulty: "VIP",   tier: "EMPIRE", duration: "당일" },
];
