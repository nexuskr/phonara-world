...
export const GAMES: GameConfig[] = [
  {
    ...
    paytable: pt(0.55, 1.37, 2.74, 5.48),
    scatterTrigger: 3,
    bonus: {
      kind: "sticky_multi",
      spins: 12,
      multWeights: [[2, 45], [3, 28], [5, 15], [10, 8], [25, 3], [100, 1]],
      collectChance: 0.36,
      maxCells: 15,
    },
  },
  ...
  },
  {
    ...
    reels: 5, rows: 3,
    symbolWeights: W_MID,
    paytable: pt(0.87, 2.07, 4.36, 8.7),
    scatterTrigger: 3,
    bonus: {
      kind: "pick_reveal",
      picks: 3,
  ...
  },
  {
    ...
    reels: 5, rows: 3,
    symbolWeights: W_HIGH,
    paytable: pt(0.86, 2.04, 4.32, 8.6),
    scatterTrigger: 3,
    bonus: {
      kind: "three_path",
      paths: [
        { name: "Asgard", spins: 8, startMult: 9, wildBoostX: 2.2 },
        { name: "Midgard", spins: 13, startMult: 3.5, wildBoostX: 1.4 },
        { name: "Helheim", spins: 18, startMult: 1, wildBoostX: 0.7, xbombChance: 0.12 },
      ],
    },
  },
  {
